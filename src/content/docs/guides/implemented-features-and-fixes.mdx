...
This reflects the current public state as of **v0.2.8.5**.
...
- Redux adds new parts, tech tree changes, new missions, EVA parachutes, helmet lights, custom flags, stickers, and a Statistics window.
...
- UI work includes a new Color Manager, reworked Orbital Info panel, better part picker search, clearer notifications, better localization/font handling, and various other UI improvements.
...
- Added SM+ orbital and launcher engines, fuel tanks, adapters, decouplers, separators, boosters, a heat shield, a conical crew pod, and probe cores.
- Added XS solid rocket boosters, camera parts, procedural body flaps, and a sticker decal part.
...
- Improved maneuver node popups and burn patch colors in map view.
...
- Added aerodynamic stress behavior for deployed parts.
- Improved SAS stability, including several edge-case bug fixes and improved high dynamic pressure behavior.
...
- Fixed cases where launching could leave the player stuck in the VAB after the loading screen.
...
- Fixed text overflow and readability issues in part subtitles, throttle text, color manager buttons, flag site names/descriptions, part sizes, and localized UI.
