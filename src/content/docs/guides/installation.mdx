...
- **Operating System:** Windows or Linux (x64). macOS is coming soon.

## Installation Steps

### 1. Download the Updater

Get the Redux Updater for your system from the [download page](/download/): `Ksp2Redux-win-x64.exe` on Windows or `Ksp2Redux-linux-x64` on Linux. It always has the newest version.
...
Install it with one line, or download `redux-cli-x64.exe` (Windows) or `redux-cli-x64` (Linux) manually from the [download page](/download/#command-line):
