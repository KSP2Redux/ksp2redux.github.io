...
description: "**Redux Update: Modding tools - Unity Editor** Recently efforts have been made in the \"modding support\" side of Redux, today I want to share with you a break..."
---
...
![Unity editor integration 1](/blog/redux-news/modding-tools-unity-editor/unity-editor-1.png)

![Unity editor integration 2](/blog/redux-news/modding-tools-unity-editor/unity-editor-2.png)
