...
![Raw Mission JSON, very hard to read/edit](../../../assets/blog/mission-editor-tutorials/mission-json.png)
...
![The beginning of the 4.1 tutorial in the editor, the mission metadata and 2 of its stages are shwon in a much more readable/editable manner](../../../assets/blog/mission-editor-tutorials/4_1_tutorial.png)
...
![2 stages in sequence with the first one having an Alittude condition of greater than 500 meters before flowing into the next](../../../assets/blog/mission-editor-tutorials/500_meters.png)
...
![An exception branch being shown in the mission editor which allows the mission to be 'failed' if the user launches from the VAB or removes a part from the assembly](../../../assets/blog/mission-editor-tutorials/failure.png)
