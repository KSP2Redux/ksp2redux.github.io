...
When it comes to Orion Drive-style engines, yes, those are planned to be added with colonies, just like the original developers were planning. We have already seen [some showcases of this engine from them](../../../assets/blog/redux-q-and-a-answers/putt-putt.png), so we will be following in a similar fashion.
...
We would love to make the clouds look like [the ones shown off in the last official KSP2 dev update](../../../assets/blog/redux-q-and-a-answers/clouds.png).
