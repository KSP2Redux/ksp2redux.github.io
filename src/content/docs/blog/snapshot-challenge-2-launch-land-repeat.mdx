...
1. Only stock and Redux parts, no additional modded ones2. An author can only win once per week3. The winners will be determined by the number of green heart reactions on their posts before we release the next snapshot
